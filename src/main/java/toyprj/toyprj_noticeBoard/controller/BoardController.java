...
public class BoardController {
    ...
    public String save(@ModelAttribute BoardDTO boardDTO) throws IOException { // @RequestParam은 html의 값을 불러오기 위해서 사용하는 것인데 DTO를 세팅해주면 일일이 RequestParam 받아 올 필요 없이 DTO 하나로 받으면 된다.
